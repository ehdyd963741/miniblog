...
const actions = {
  fetchReadMemo(context) {
    axios.get('http://ehdyd963741.dothome.co.kr/page-miniblog/read.php')
      .then(response => {
  ...
  fetchAddMemo(context, obj) {
    ...
    axios.get(`http://ehdyd963741.dothome.co.kr/page-miniblog/write.php?user=${addData.user}&title=${addData.title}&date=${addData.date}&icon=${ addData.icon}`)
      .then(response => {
        // console.log(response.data);
  ...
  fetchDeleteMemo({commit}, obj) {
    ...
    // 아래를 실행한다.
    console.log('삭제', obj);
    axios.get(`http://ehdyd963741.dothome.co.kr/page-miniblog/delete.php?id=${obj.id}`)
    .then(response => {
  ...
  fetchUpdateMemo({commit}, obj) {
    ...
    axios.get(`http://ehdyd963741.dothome.co.kr/page-miniblog/update.php?id=${obj.item.id}&complete=${complete}`)
    .then(response => {
  ...
  fetchClearMemo({commit}) {
    ...
    // 정상적으로 처리되었다면
    // 아래를 실행한다.
    axios.get("http://ehdyd963741.dothome.co.kr/page-miniblog/delete.php?id=all")
    .then(response => {
...
const mutations = {
  ...
  ADD_MEMO(state, payload) {
    ...
    // 가지고 와서 목록 1개를 추가한다.
    axios.get(`http://ehdyd963741.dothome.co.kr/page-miniblog/get.php?user=${payload.user}`)
      .then(response => {
